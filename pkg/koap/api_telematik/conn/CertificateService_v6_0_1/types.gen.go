package CertificateService_v6_0_1

import (
	"encoding/xml"
	"github.com/spilikin/koap-go/pkg/koap/api_telematik/conn/CertificateServiceCommon_v2_0"
...
type CheckCertificateExpiration struct {
	...
	Crypt      string                        `xml:"http://ws.gematik.de/conn/CertificateService/v6.0 Crypt,omitempty"`
}
