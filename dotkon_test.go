...
func TestParseDotkonEnvExpansion(t *testing.T) {
	...
	cred, ok := config.Credentials.(koap.CredentialsConfigBasic)
	if !ok {
...
func TestParseDotkonPKCS12(t *testing.T) {
	...
	cred, ok := config.Credentials.(koap.CredentialsConfigPKCS12)
	if !ok {
...
func TestParseDotkonSystem(t *testing.T) {
	...
	cred, ok := config.Credentials.(koap.CredentialsConfigSystem)
	if !ok {
